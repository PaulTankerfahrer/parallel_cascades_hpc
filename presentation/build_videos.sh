...
ffmpeg -y -loglevel error -ss 2.2 -i "$HERE/videos/cascade_1_geschwindigkeit.mp4" -frames:v 1 "$HERE/stills/still_1.png"
ffmpeg -y -loglevel error -ss 4.8 -i "$HERE/videos/cascade_2_schaden.mp4"        -frames:v 1 "$HERE/stills/still_2.png"
ffmpeg -y -loglevel error -ss 4.8 -i "$HERE/videos/cascade_3_verschiebung.mp4"   -frames:v 1 "$HERE/stills/still_3.png"
ffmpeg -y -loglevel error -ss 4.8 -i "$HERE/videos/cascade_4_mehrere_pka.mp4"    -frames:v 1 "$HERE/stills/still_4.png"
